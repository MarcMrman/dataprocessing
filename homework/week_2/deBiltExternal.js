...
var filename = "XMLHttpRequest.txt";
var tempTXT = new XMLHttpRequest();
tempTXT.onreadystatechange = function(){
	if (tempTXT.readyState == 4){
		if (tempTXT.status == 200){
			drawline(tempTXT.responseText)
		}
	}
  }
tempTXT.open("GET", filename, true);
tempTXT.send();
